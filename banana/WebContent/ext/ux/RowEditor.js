 ...
 */
/**
*在stopEditing中设值时有bug，此处已修复 2013/12/18
*/
Ext.ns('Ext.ux.grid');
        ...
        for(var i = 0, len = cm.getColumnCount(); i < len; i++){
            if(!cm.isHidden(i)){
                ...
                if(!Ext.isEmpty(dindex)){
                    ...
                    //此处修复combo下拉框时值不对的bug,此时需要注意普通组件设置问题
                    if(!Ext.isEmpty(fields[i].lastSelectionText) && fields[i].originalValue != fields[i].value){
                    	//console.log(fields[i]);
                    	value = fields[i].lastSelectionText;
                    	//console.log(value);
                    }
