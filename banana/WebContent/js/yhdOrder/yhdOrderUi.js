...
yhdOrderUi=Ext.extend(Ext.Panel,{
	id:'yhdOrderUi',
	border:false,
	layout:'border',
			...
			items:[{
				...
				items:[{
					...
					items:[{
							...
							labelAlign : 'right',
							layout:'form',
							items:[{fieldLabel:'门店名称',name:'mdCode',xtype:'textfield'}]
						}
,{
							columnWidth:.30,
							defaults : {anchor : '-10', allowBlank : true,xtype : 'textfield', msgTarget : 'side',labelWidth:60},
							labelAlign : 'right',
							layout:'form',
							items:[{fieldLabel:'联系人',name:'mdName',xtype:'textfield'}]
						}
		...
		yhdOrderUi.superclass.initComponent.call(this);
	}
});
