PaymentBillDetailGrid = Ext.extend(Ext.grid.GridPanel, {
	id: 'paymentBillDetailGrid',
	frame: false,
    ...
    initComponent: function() {
       ...
       var billDetailStore = createStore(BillDetail, false, {}, "budget/paymentApplyDocumentDetail/getDetailsByDepartment.do");
       billDetailStore.on({
	    ...
	    PaymentBillDetailGrid.superclass.initComponent.call(this);
    }
});
