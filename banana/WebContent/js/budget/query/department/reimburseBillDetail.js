/**职员工作简历管理**/
ReimburseBillDetailGrid = Ext.extend(Ext.grid.GridPanel, {
	id: 'reimburseBillDetail',
	frame: false,
    ...
    initComponent: function() {
       ...
       var billDetailStore = createStore(BillDetail, false, {}, "budget/reimburseDocumentDetail/getDetailsByDepartment.do");
       billDetailStore.on({
	    ...
	    ReimburseBillDetailGrid.superclass.initComponent.call(this);
    }
});
