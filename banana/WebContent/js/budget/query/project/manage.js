	...
	initComponent: function() {
		 ...
		 if(!Ext.isEmpty(Ext.getCmp("printButton"))){
			 Ext.getCmp("printButton").on("click", function(){
	 			 ...
	 			 if(formPanel.findField("categoryCode").getValue()!=""){
	 				 condition+="&categoryCode="+baseParams.categoryCode;
	 			 }
	 			 if(formPanel.findField("startDate").getValue()!=""){
	 				 condition+="&startDate="+baseParams.startDate;
	 			 }
	 			 if(formPanel.findField("projectName").getValue()!=""){
	 				 condition+="&projectName="+baseParams.projectName;
	 			 }
	 			 if(formPanel.findField("endDate").getValue()!=""){
	 				 condition+="&endDate="+baseParams.endDate;
	 			 }
	 			 if(formPanel.findField("projectStatus").getValue()!=""){
	 				 condition+="&projectStatus="+baseParams.projectStatus;
	 			 }
	 			 printReport("213", "query_project",condition);
			 });
		 }
