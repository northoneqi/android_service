BillDetailGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
       ...
       billDetailStore = createStore(BillDetail, false, {}, "budget/feeYearDocumentDetail/getDetails.do");
       billDetailEditor = new Ext.ux.grid.RowEditor({
        ...
        billDetailEditor.on("afteredit", function(roweditor, changes, record12, rowIndex){
        	setTotalPanel();
