BillDetailGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
       ...
       billDetailStore = createStore(BillDetail, false, {}, "budget/projectBudgetDocumentDetail/getDetails.do");
...
//		    			var record = Ext.getCmp("billDetailGrid").getStore().getAt(billDetailEditor.getEditingRow());
//			        	console.log(record);
//			        	record.data.lastMoney = newValue;
//			 			record.data.grandTotalMoney = newValue;
//			 			console.log(record);
//			 			Ext.getCmp("billDetailGrid").view.refresh();
			 			//alert(newValue);
			 			//billDetailEditor.refreshFields();
		            }
	    		}
