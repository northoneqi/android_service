mainGrid=Ext.extend(Ext.grid.GridPanel,{
    ...
    initComponent: function() {
		   ...
		   reader:new Ext.data.JsonReader({
			...
			pageSize: pageSize,
			 ...
			 proxy: new Ext.data.HttpProxy ({ 
				url:'budget/monthExpenseDocument/queryPersonal.do'
			 })      
	 	});
		store.on({
		...
		var columns=[
	        ...
	        {header: "<center>预算起始日期</center>", width: 100, sortable: true, dataIndex: 'startBudgetDate',renderer:function(v){
	      		 if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
	        ...
	        {header: "<center>预算截止日期</center>", width: 100, sortable: true, dataIndex: 'endBudgetDate',renderer:function(v){
	      		 if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
