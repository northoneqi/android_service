	 ...
	 initComponent:function(){
		Ext.applyIf(this,{
			...
			items:[{
		    	...
		    	iconCls: 'saveIcon',
				handler: function(){
					Ext.ux.Form.submitForm(Ext.getCmp("billFormPanel"), "budget/repaymentDocument/save.do", 
				  ...
				  iconCls: 'edit1Icon',
				  handler: function(){
						Ext.ux.Form.submitForm(Ext.getCmp("billFormPanel"), "budget/repaymentDocument/update.do", 
		            		function(form, action){
		            			Ext.Msg.alert('消息', action.result.data.instruction);
		            			Ext.getCmp("addWindow").close();
		            			Ext.getCmp("mainGrid").getStore().load();
						...
						items: [{
							...
							items:[
							    ...
							    createComboTree({
									...
									fieldLabel: '<span style="color:red">*</span>申请部门',
							...
							items:[
							    ...
							    {fieldLabel:'<span style="color:red">*</span>还款金额', name: 'budgetYear', xtype: 'numberfield', minValue: 0}
							 ]
						}, {
							labelAlign : 'right',
							layout:'form',
