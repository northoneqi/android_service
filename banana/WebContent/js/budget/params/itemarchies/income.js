IncomeGrid = Ext.extend(Ext.grid.GridPanel, {
	id: 'incomeGrid',
	frame: false,
    ...
    initComponent: function() {
       ...
       var billDetailStore = createStore(BillDetail, false, {}, "budget/collection1/getDetails.do");
       var billDetailEditor = new Ext.ux.grid.RowEditor({
	    ...
	    this.tbar = [{
	        ...
	        handler: function(){
	            ...
	            Ext.getCmp("incomeGrid").getView().refresh();
	            Ext.getCmp("incomeGrid").getSelectionModel().selectRow(billDetailStore.getCount());
	        ...
	        handler: function(){
	            billDetailEditor.stopEditing();
	            var s = Ext.getCmp("incomeGrid").getSelectionModel().getSelections();
	    ...
	    IncomeGrid.superclass.initComponent.call(this);
    }
});
