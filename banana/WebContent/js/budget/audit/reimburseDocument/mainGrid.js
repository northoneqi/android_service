mainGrid=Ext.extend(Ext.grid.GridPanel,{
    ...
    initComponent: function() {
		   ...
		   reader:new Ext.data.JsonReader({
			...
			pageSize: pageSize,
			 ...
			 proxy: new Ext.data.HttpProxy ({ 
				url:'budget/reimburseDocument/queryAudit.do'
			 })      
	 	});
		store.on({
		...
		var columns=[
	        ...
	        {header: "<center>核销金额</center>", width: 100, sortable: true, xtype: 'numbercolumn',
	        	dataIndex: 'verificationMoney', format: '0.00', align:"right"},
	        {header: "<center>实发金额</center>", width: 100, sortable: true,
	        	dataIndex: 'totalMoney', format: '0.00', align:"right",
	        	renderer:function(v, metaData, record){
	        		if(v=='null'){
		      			return '';
		      		}else{
		      			return Ext.util.Format.number((record.data.totalMoney-record.data.verificationMoney), "0.00");
		      		}
	        	}
	        },
