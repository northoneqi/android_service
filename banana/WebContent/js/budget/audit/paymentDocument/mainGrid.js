mainGrid=Ext.extend(Ext.grid.GridPanel,{
    ...
    initComponent: function() {
		   ...
		   reader:new Ext.data.JsonReader({
			...
			pageSize: pageSize,
			 ...
			 proxy: new Ext.data.HttpProxy ({ 
				url:'budget/paymentDocument/queryAudit.do'
			 })      
	 	});
		store.on({
		...
		var columns=[
	        ...
	        {header: "<center>单据状态</center>", width: 60, sortable: true, dataIndex: 'documentState',renderer:function(v){
	      		 if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
	        ...
	        {header: "<center>是否入账</center>", width: 60, sortable: true, dataIndex: 'entered',renderer:function(v){
	      		  if(v=='null'){
	      			return '否';
	      		}else{
	      			return v ? '是' : '否';
	        ...
	        {header: "<center>入账人</center>", width: 60, sortable: true, dataIndex: 'enterPeople',renderer:function(v){
	      		  if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
	        ...
	        {header: "<center>单据来源</center>", width: 100, sortable: true, dataIndex: 'documentSource',renderer:function(v){
	      		 if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
	        ...
	        {header: "<center>单据号码</center>", width: 100, sortable: true, dataIndex: 'documentSourceNum',renderer:function(v){
	      		 if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
	        ...
	        {header: "<center>应付金额</center>", width: 100, sortable: true, xtype: 'numbercolumn',
	        	dataIndex: 'totalMoney', format: '0.00', align:"right"},
	        {header: "<center>销账金额</center>", width: 100, sortable: true, xtype: 'numbercolumn',
	        	dataIndex: 'chargeOffMoney', format: '0.00', align:"right"},
	        {header: "<center>实付金额</center>", width: 100, sortable: true, xtype: 'numbercolumn',
	        	dataIndex: 'factMoney', format: '0.00', align:"right"},
	       {header: "<center>事由</center>", width: 135, sortable: true, dataIndex: 'remark',renderer:function(v){
	     		if(v=='null' || v == ""){
	     			return '';
	     		}else{
	     			return v;
