mcirowaterGrid=Ext.extend(Ext.grid.GridPanel,{
    ...
    initComponent: function() {
		...
		store = new Ext.data.Store({
		   ...
		   reader:new Ext.data.JsonReader({
		    ...
		    proxy: new Ext.data.HttpProxy ({ 
				url:ctx+"/wechat/mcirowater/queryWaterComr.do"
			 })      
	 	});
		...
		var columns=[
	        ...
	        {header: "<center><span style='font-weight:bold'>申请者姓名</span></center>", align:'center',width: 80,height:40, sortable: true, dataIndex: 'linkMan', renderer:function(v){
	      		if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
	        ...
	        {header: "<center><span style='font-weight:bold'>公司名称</span></center>", width:100, sortable: true, dataIndex: 'companyName', renderer:function(v){
	      		if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
	        ...
	        {header: "<center><span style='font-weight:bold'>公司地址</span></center>", width: 140, sortable: true, dataIndex: 'address', renderer:function(v){
	      		if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
	        ...
	        {header: "<center><span style='font-weight:bold'>水品牌</span></center>", width: 80, sortable: true, dataIndex: 'brand', renderer:function(v){
	      		if(v=='null'){
	      			return '';
	      		}else{
	      			return v;
