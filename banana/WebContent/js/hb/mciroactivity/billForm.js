...
var ActivityStatusStore = new Ext.data.ArrayStore({
    fields: ['value', 'state'],
    data : ActivityStatus // from states.js
});
			...
			items:[{
				...
				items: [{
					...
					items:[ 
				       ...
				       // {fieldLabel:'<span style="color:red">*</span>众筹人份数', name: 'playNum', xtype:'numberfield', value: 0},
				        {fieldLabel:'<span style="color:red">*</span>最少允许支付剩余金额的份数', name: 'minPayNumber', type: 'numberfield', value: 0, minValue: 0},
					...
					items:[
   					 ...
   					 {fieldLabel:'<span style="color:red">*</span>最多发起次数', name: 'maxPlayMore', value: userName, xtype:'numberfield', value: 1, min: 0},
   					  {fieldLabel:'<span style="color:red">*</span>活动结束时间', name: 'activityEndTimes', xtype:'datetimefield',format:'Y-m-d', value: new Date()}
					 ]
				}, {
					defaults : {allowBlank : false,xtype : 'textfield', msgTarget : 'side',labelWidth:80, anchor : anchor_w},
					labelAlign : 'right',
					...
					items:[
							...
							{fieldLabel:'<span style="color:red">*</span>是否可以自己支付', 
	   					    ...
	   					    {fieldLabel:'<span style="color:red">*</span>最多支付次数', name: 'maxPayMore', xtype:'numberfield', value: 0, minValue: 0},
				...
				items:[{
						...
						items:[
					        ...
					        {name: 'productImg', hidden: true, allowBlank: true},
						...
						items:[
	   					    ...
	   					    {fieldLabel:'<span style="color:red">*</span>众筹商品数量', name: 'productNum', xtype:'numberfield'}
						 ]
				},{
					defaults : {allowBlank: false, xtype: 'textfield', msgTarget: 'side', labelWidth:80, anchor : anchor_w},
					labelAlign : 'right',
					...
					xtype: 'container',
					items:[
   					    {fieldLabel:'<span style="color:red">*</span>众筹价', name: 'productPrice', xtype:'numberfield', style:'background-color: #F6F6F6; background-image: none;',readOnly: true}
					 ]
				}, {
					labelAlign : 'right',
					layout:'form',
