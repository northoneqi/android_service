...
<body style="background:url(<c:url value='images/wechatmanage/topbg.gif'/>) repeat-x;">

    <div class="topleft">
    <a href="main.do" target="_parent"><img src="images/wechatmanage/logo.png" title="系统首页" /></a>
    </div>
    ...
    <div class="topright">    
    <ul>
    <li><span><img src="images/wechatmanage/help.png" title="帮助"  class="helpimg"/></span><a href="#">帮助</a></li>
    <li><a href="#">关于</a></li>
